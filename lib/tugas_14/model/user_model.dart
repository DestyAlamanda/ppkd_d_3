...
//
//     final jikanRespon = jikanResponFromJson(jsonString);

import 'dart:convert';

JikanRespon jikanResponFromJson(String str) =>
    JikanRespon.fromJson(json.decode(str));

String jikanResponToJson(JikanRespon data) => json.encode(data.toJson());

class JikanRespon {
  Pagination? pagination;
  List<Datum>? data;

  JikanRespon({this.pagination, this.data});

  factory JikanRespon.fromJson(Map<String, dynamic> json) => JikanRespon(
